      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div>
            ...
            <p className='flex items-center gap-1 text-sm font-mediumtext-neutral-800 mt-3'>About: </p>
          ...
          <div className='flex gap-1 pt-2'>
            <input onChange={()=> isEdit && setProfileData(prev=>({...prev,availability:!profileData.availability}))} checked={profileData.availability} type="checkbox" name="" id="" />
